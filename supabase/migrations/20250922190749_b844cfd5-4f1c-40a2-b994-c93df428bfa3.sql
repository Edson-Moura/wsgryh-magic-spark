...
CREATE TYPE public.app_role AS ENUM ('admin', 'manager', 'chef', 'staff', 'inventory');
...
CREATE OR REPLACE FUNCTION public.has_restaurant_role(user_id UUID, restaurant_id UUID, required_role app_role)
RETURNS BOOLEAN
LANGUAGE sql
STABLE
SECURITY DEFINER
